...
* Brave VPN
* Brave AI/Leo (some people may like Leo, in which case you can reenable it following the [customization guide](https://github.com/just-a-dev20/brave-debullshitinator/wiki/Customization))
...
Windows: https://github.com/just-a-dev20/brave-debullshitinator/wiki/Installation-instructions#windows
...
MacOS: We currently do not officaly support MacOS, however testers for it would be appreciated.

Linux: https://github.com/just-a-dev20/brave-debullshitinator/wiki/Installation-instructions#linux

-------

# Customizing

[Please see the wiki for instructions on how to change modifications.](https://github.com/just-a-dev20/brave-debullshitinator/wiki/Customization)

# Additional Resources

You can check out similar tools [here](https://github.com/just-a-dev20/brave-debullshitinator/wiki/Additional-Resources#other-tools) and see domains to blacklist with your dns [here](https://github.com/just-a-dev20/brave-debullshitinator/wiki/Additional-Resources#brave-telemetrytracking-dns-blacklists)
